...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sampleresult = resultsArray[0];
    ...
    var yticks = otu_ids.slice(0, 10).map(val => `OTU ${val}`).reverse();

    // 8. Create the trace for the bar chart. 

    // var toptenotu_ids = otu_ids.splice(0,11)sort(a-b)
    ...
    var bubbleData = [{
        ...
        marker: {
            size: sample_values,
            color: ['rgb(93, 164, 214)', 'rgb(255, 144, 14)',  'rgb(44, 160, 101)', 'rgb(255, 65, 54)', 'rgb(50, 150, 200)' ],
        }
